...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_ibo8r8u", "template_0hbl206", form.current, {
        publicKey: "pyojgHq-kd3p9vPyD",
      })
      e.target.reset()
  };
  return (
          ...
          <div className="contact_info">
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                saivenkatpentakota@gmail.com
              </span>

              <a
                href="mailto:saivenkatpentakota@gmail.com"
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">9052174956</span>

              <a
                href="https://api.whatsapp.com/send?phone=9052174956&text=Hello,more information!"
                className="contact_button"
              >
                Write me
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
